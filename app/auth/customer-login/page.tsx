  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (formData.email && formData.password) {
        // Simulate successful login - redirect to tracking page
        ...
        <div className="max-w-md w-full space-y-8">
          <Card className="border-2 border-gray-100 shadow-lg">
            <CardHeader className="bg-[#f8fafc] text-center">
              ...
              <CardTitle className="text-2xl text-[#334155]">تسجيل دخول العملاء</CardTitle>
              <p className="text-gray-600 mt-2">ادخل لتتبع طلباتك</p>
            </CardHeader>
          ...
          <div className="text-center">
            <p className="text-gray-600">
              ليس لديك حساب؟{" "}
              <Link href="/auth/customer-register" className="text-[#2563eb] hover:underline font-medium">
                إنشاء حساب جديد
              </Link>
            </p>
          </div>
