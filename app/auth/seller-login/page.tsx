        ...
        <div className="max-w-md w-full space-y-8">
          <Card className="border-2 border-gray-100 shadow-lg">
            <CardHeader className="bg-[#f8fafc] text-center">
              ...
              <CardTitle className="text-2xl text-[#334155]">تسجيل دخول البائعين</CardTitle>
          ...
          <div className="text-center">
            <p className="text-gray-600">
              ليس لديك حساب؟{" "}
              <Link href="/auth/seller-register" className="text-[#2563eb] hover:underline font-medium">
                سجل كبائع جديد
              </Link>
            </p>
          </div>
