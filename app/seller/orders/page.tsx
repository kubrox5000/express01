...
import { Search, Filter, Eye, Edit, Plus, Package, Clock, CheckCircle, AlertCircle } from "lucide-react"
...
export default function SellerOrdersPage() {
  ...
  const orders = [
    ...
    },
    {
      ...
      customerAddress: "حي الرياض، الرباط",
    ...
    },
    {
      ...
      customerAddress: "المدينة القديمة، فاس",
    ...
    <div className="p-6">
      ...
      <div className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">إدارة ومتابعة جميع طلبات التوصيل</p>
        </div>
        <Dialog>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>إضافة طلب توصيل جديد</DialogTitle>
            </DialogHeader>
            <div className="space-y-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">اسم العميل *</label>
                  <Input placeholder="اسم العميل الكامل" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">رقم الهاتف *</label>
                  <Input placeholder="+212 6XX-XXXXXX" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-[#334155] mb-2">العنوان الكامل *</label>
                <Textarea placeholder="العنوان الكامل للتوصيل" rows={3} />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">وصف الطرد *</label>
                  <Input placeholder="وصف محتويات الطرد" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">قيمة الطرد (درهم)</label>
                  <Input type="number" placeholder="0" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">مبلغ الدفع عند الاستلام</label>
                  <Input type="number" placeholder="0" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#334155] mb-2">نوع التوصيل</label>
                  <Select>
                    <SelectTrigger>
                      <SelectValue placeholder="اختر نوع التوصيل" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="standard">عادي (3-5 أيام)</SelectItem>
                      <SelectItem value="express">سريع (1-2 أيام)</SelectItem>
                      <SelectItem value="same_day">نفس اليوم</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              <div className="flex justify-end gap-4">
                ...
                <Button className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white">إنشاء الطلب</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#334155]">1,234</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#334155]">45</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#334155]">1,166</p>
              </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">وصف الطرد</TableHead>
            ...
            <TableBody>
              {filteredOrders.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell>{order.packageDescription}</TableCell>
                        ...
                        <DialogContent className="max-w-2xl">
                          ...
                          <div className="space-y-6 py-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div>
                                <h3 className="font-semibold text-[#334155] mb-3">معلومات العميل</h3>
                              ...
                              <div>
                                <h3 className="font-semibold text-[#334155] mb-3">معلومات الطرد</h3>
                                <div className="space-y-2 text-sm">
                                  <p>
                            ...
                            <div>
                              <h3 className="font-semibold text-[#334155] mb-3">حالة الطلب</h3>
                              <div className="flex items-center gap-4">
                                {getStatusBadge(order.status)}
                                {order.driverName && (
                                  <p className="text-sm text-gray-600">السائق: {order.driverName}</p>
                                )}
                              </div>
                            </div>
                          </div>
